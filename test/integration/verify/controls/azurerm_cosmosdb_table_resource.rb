...
control 'azurerm_cosmosdb_table_resource' do
  only_if { !cosmosdb_database_account.nil? }

  describe azurerm_cosmosdb_table_resource(resource_group: resource_group, cosmosdb_database_account: cosmosdb_database_account, cosmosdb_table_name: cosmosdb_table_name) do
