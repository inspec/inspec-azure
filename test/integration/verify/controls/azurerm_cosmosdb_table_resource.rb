...
control 'azurerm_cosmosdb_gremlin_resource' do
  ...
  describe azurerm_cosmosdb_gremlin_resource(resource_group: resource_group, cosmosdb_database_account: cosmosdb_database_account, cosmosdb_table_name: cosmosdb_table_name) do
