...
class AzureIotHubEventHubConsumerGroup < AzureGenericResource
  ...
  example <<-EXAMPLE
    describe azure_iothub_event_hub_consumer_group(resource_group: 'RESOURCE_GROUP_NAME', resource_name: 'RESOURCE_NAME', event_hub_endpoint: 'EVENT_HUB_ENDPOINT', consumer_group: 'CONTAINER_GROUP') do
