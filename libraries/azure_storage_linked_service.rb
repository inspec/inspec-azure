...
class AzureStorageLinkedService < AzureGenericResource
  name 'azure_storage_linked_service'
  ...
  def initialize(opts = {})
    ...
    # providers/Microsoft.DataFactory/factories/${factoryName}/linkedservices/AzureStorageLinkedService?
    # api-version=${apiVersion}
    #
    # The dynamic part that has to be created in this resource:
    #   Microsoft.DataFactory/factories/${factoryName}/linkedservices/AzureStorageLinkedService?
    #     # api-version=${apiVersion}
    #
    ...
    #   - resource_provider => Microsoft.DataFactory/factories/${factoryName}
    #     The `specific_resource_constraint` method will validate the user input
    #       not to accept a different `resource_provider`.
    #
    opts[:resource_provider] = specific_resource_constraint('Microsoft.DataFactory/virtualMachines', opts)
  ...
  def to_s
    super(AzureStorageLinkedService)
  end
end
