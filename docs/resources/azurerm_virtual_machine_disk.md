...
> <b>WARNING</b>  This resource will be deprecated in InSpec Azure Resource Pack version **2**. Please start using fully backward compatible [`azure_virtual_machine_disk`](azure_virtual_machine_disk.md) InSpec audit resource.
