...
class AzureEventHubAuthorizationRule < AzureGenericResource
  ...
  example <<-EXAMPLE
    describe azure_event_hub_authorization_rule(resource_group: 'RESOURCE_GROUP_NAME',#{' '}
                                                namespace_name: 'NAMESPACE_NAME',#{' '}
                                                event_hub_endpoint: 'EVENT_HUB_ENDPOINT_NAME',#{' '}
                                                authorization_rule_name: 'AUTHORIZATION_RULE_NAME') do
